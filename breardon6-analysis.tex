...
\begin{document}
  ...
  \Fref{fig:sa-params} shows the training and test error curves for the cancer data sets using simulated annealing for weight optimization. The different series in the figure represent different cooling rates.
